...
export function SiteNav() {
  ...
  const links = (
    <>
      <Link href="/#features" className="text-sm text-neutral-300 hover:text-white transition-colors" onClick={() => setOpen(false)}>
        Features
      </Link>
      <Link href="/#pricing" className="text-sm text-neutral-300 hover:text-white transition-colors" onClick={() => setOpen(false)}>
        Pricing
      </Link>
      <Link href="/#faq" className="text-sm text-neutral-300 hover:text-white transition-colors" onClick={() => setOpen(false)}>
        FAQ
      </Link>
      <Link href="/tool" className="text-sm text-neutral-300 hover:text-white transition-colors" onClick={() => setOpen(false)}>
        Free Tool
      </Link>
    </>
  );
