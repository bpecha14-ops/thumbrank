    ...
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="relative w-full max-w-md rounded-2xl border border-white/10 bg-[#111] p-8">
        ...
        <p className="mt-2 text-sm text-neutral-400 text-center">
          {mode === 'login' ? 'Sign in to access unlimited previews and A/B testing' : 'Start with 3 free previews — upgrade anytime'}
        </p>
        {error && (
        ...
        <button
          ...
          className="mt-6 w-full flex items-center justify-center gap-3 rounded-lg border border-white/10 bg-white px-4 py-2.5 text-sm font-medium text-black hover:bg-neutral-100 transition-colors disabled:opacity-50"
        >
          {googleLoading ? (
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 bg-[#0a0a0a] border-white/10 text-white placeholder:text-neutral-600"
              />
            </div>
          </div>
          <div className="space-y-2">
