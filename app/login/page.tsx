      ...
      <div className="mx-auto max-w-md px-4 sm:px-6 py-16">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-[#1C1428] px-2 text-neutral-500">or use email</span>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full rounded-md border border-white/10 bg-[#0a0a0a]/60 px-3 py-2 pl-10 text-sm text-white placeholder:text-neutral-600 outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500"
              />
            </div>
          </div>
        ...
        <p className="mt-6 text-center text-sm text-neutral-400">
          {mode === 'signup' ? (
            ...
            <>
              ...
              <Link href="/login?mode=signup" className="text-pink-400 hover:text-pink-300">Get started free</Link>
            </>
          )}
        </p>
      </div>
